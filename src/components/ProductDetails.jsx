  ...
  return (
    <div className="flex flex-col md:flex-row gap-8">
      ...
      <div className="md:w-1/2 flex justify-center items-center bg-gray-100 rounded-lg overflow-hidden shadow-md">
        ...
        <Image src={product.imageUrl} alt={product.name} className="w-full h-auto" width={100} height={60}/>
      </div>
      ...
      <div className="md:w-1/2 space-y-6">
        ...
        <button
          onClick={onAddToCart}
          // BUG 7: Missing focus styles
          className="w-full py-4 bg-blue-600 text-white text-xl font-bold rounded-lg shadow-lg hover:bg-blue-700 transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-400"
        >
          Add to Cart
        </button>
      </div>
